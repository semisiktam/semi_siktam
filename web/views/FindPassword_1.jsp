...
<link rel="stylesheet" href="/siktam/resources/css/header_idpw.css"
	type="text/css" />
<link rel="stylesheet" href="/siktam/resources/css/FindPassword_1.css"
	type="text/css" />
			...
			<div id="area2">
				<div class="div2">
					...
					<input type="text" class="text" placeholder="아이디를 입력해 주세요"
						id="nextPwdId" name="nextPwdId" required>&nbsp; <input
						type="button" id="nextPwd" value="다음단계">
				</div>

				<div class="div3">
					아이디를 모르시나요? &nbsp;<a href="IdFind_1.jsp" style="color: black;">아이디
						찾기 (이동)</a>
				</div>
				<br>
			</div>
